# -*- coding: utf-8 -*-
"""
Created on Sun Mar 15 00:57:49 2020
...
arduino = serial.Serial("com3", 9600)   #Serial port to which arduino is connected and Baudrate
...
def CreatePlot(): #Create a function that makes our desired plot
    ...
    plt.grid(True)
    plt.ylim(25,70)             #Set limits of second y axis
...
while True: # While loop that loops forever
    while (arduino.inWaiting()==0): #Wait here until there is data
        pass #do nothing
    arduinoString = arduino.readline().decode("utf-8") #read the data from serial port
